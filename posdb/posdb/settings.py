...
SECRET_KEY = 'django-insecure-m+$tl$7+dmsycct2m&nfps)73hwtmzi3xp$&*eu^9=fevpw#cj'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'phpmyadmin', # បង្កើត database ក្នុង phpmyadmin ជាមុនសិន
        'USER': 'root',
        'PASSWORD': '',
        'HOST': '127.0.0.1',
        'PORT': '3307', # ប្រសិនបើ XAMPP ជាប់ Port 3306 ត្រូវប្តូរលេខនេះតាមការកែរបស់អ្នក
        'OPTIONS': {
